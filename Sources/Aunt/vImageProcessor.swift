...
@discardableResult
public func vImageBuffer_InitWithCGImage(_ sourceBuffer: vImageBuffer, _ sourceImage: CGImage) -> vImage_Error {
    
    let colorSpace = sourceImage.colorSpace ?? CGColorSpaceCreateDeviceGray()
...
public func vImageBuffer_InitWithCVImage(
    ...
    -> vImage_Error {
        ...
        return vImageBuffer_InitWithCVPixelBuffer(
            sourceBuffer,
            &desiredFormat,
            imageBuffer,
            cvImageFormat,
...
public func vImageFlipHorizontally_ARGB8888(
    _ sourceBuffer: vImageBuffer,
    _ destinationBuffer: vImageBuffer)
    -> vImage_Error {
        ...
        return vImageHorizontalReflect_ARGB8888(
            sourceBuffer,
            destinationBuffer,
            .init(kvImageNoFlags))
}
